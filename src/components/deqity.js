  ...
  return (
    <>
      ...
      >
        ...
        <p>
          A decentralized marketplace to buy and sell tokenized private equity.
          It works by representing shares as erc-20 tokens then allowing
          shareholders to make transcactions with said shares. The owner of the
          contract can also inact a special sale in which all the shareholders
          are diluted and compensated according to the dilution amount. I
          developed multiple complex smart contracts and an frontend to make it
